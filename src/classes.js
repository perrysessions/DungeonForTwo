...
export const CLASSES = {
  ...
  druid: {
    ...
    stats: {
      maxHp: 110, maxMana: 85, attackDamage: 9, attackCooldown: 0.44,
    ...
    tree: [
      ...
      node('d_hp', 'Thick Hide', '+14 Max HP', { maxRank: 4, stats: { maxHp: 14 } }),
      node('d_mana', 'Wild Mana', '+12 Max Mana', { maxRank: 3, stats: { maxMana: 12 } }),
      node('d_regen', 'Natural Healing', '+0.5 HP regen/sec', { maxRank: 3, stats: { hpRegen: 0.5 } }),
    ],
  },
  rogue: {
